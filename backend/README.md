...
**Standard bitrate for J1939:** 250 kbps (trucks, agriculture, marine). See [J1939 Guide](https://github.com/Chanchaldhiman/CANviz/blob/main/docs/j1939.md) for full protocol documentation, limitations, and DBC-based signal decode.
